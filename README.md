...
## Overview
<!-- Provide a high level overview of what this application is and why you are building it, beyond the fact that it's an assignment for a Code Fellows 301 class. (i.e. What's your problem domain?) --> To create a user friendly and dynamic webpage for most screens.

## Getting Started
<!-- What are the steps that a user must take in order to build this app on their own machine and get it running? -->
The user must plan the structure of their css files to complete this task. They must know how to manipulate elements in css to hover the hamburger menu to show the navigation.
## Architecture
<!-- Provide a detailed description of the application design. What technologies (languages, libraries, etc) you're using, and any other relevant design information. -->
Strictly HTML and CSS documents were used and manipulated. Specifically the base, layout, and modules were all used to organize the css.
## Change Log
